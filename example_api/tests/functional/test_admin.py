...
class TestAdmin(TestView):
    def setUp(self):
        ...
        self.system = User(username='test_system', password='123', email='test_system@email.com', groups=['admin']).save()
    ...
    def test_user_create(self):
        self.app.post_json('/users',
            dict(username='new_user', password='123', email='new_user@email.com'),
            **self._status(201))
    ...
    def test_user_update(self):
        response = self.app.put_json('/users/test_user',
                                    dict(),
                                    **self._status(200))
